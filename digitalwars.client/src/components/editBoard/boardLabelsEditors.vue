...
<script setup lang="ts">
  ...
  const removeLabelUp = (index: number) => { // Jawne typowanie parametru
  ...
  const updateLabelUp = (index: number, value: string) => { // Jawne typowanie parametrów
    const updatedLabels = [...props.labelsUp];
  ...
  const removeLabelRight = (index: number) => { // Jawne typowanie parametru
  ...
  const updateLabelRight = (index: number, value: string) => { // Jawne typowanie parametrów
    const updatedLabels = [...props.labelsRight];
    updatedLabels[index] = value;
    emit('update:labelsRight', updatedLabels);
    emit('update');
