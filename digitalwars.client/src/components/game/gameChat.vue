<template>
   <div class="bg-tertiary border border-lgray-accent lg:rounded-lg overflow-hidden relative animate-fade-up flex flex-col h-full">
       ...
       <div class="flex-1 overflow-y-auto p-4 space-y-6 custom-scrollbar">
            <div class="flex justify-start">
                <div class="bg-surface-700 text-white rounded-2xl rounded-bl-md px-4 py-2 max-w-xs break-words">
       ...
       <div class="flex items-end p-4 flex-shrink-0">
          <textarea placeholder="Wyślij wiadomość ..." v-model="message" 
           ...
           <div class="ml-2 h-10 w-10 rounded-full border border-lgray-accent bg-tertiary text-white flex items-center justify-center cursor-pointer
