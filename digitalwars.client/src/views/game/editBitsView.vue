<template>
  <div class="p-6 text-white">
    ...
    <div v-if="selectedTeam" class="max-w-md mx-auto">
      <div
        class="mb-4 flex items-center justify-center gap-4 bg-secondary p-4 rounded-lg shadow-inner"
      >
    ...
    <div v-else-if="!teams.length" class="text-center text-gray-400">
      Nie znaleziono drużyn dla tej gry.
    </div>
    <div v-else-if="!selectedTeam" class="text-center text-gray-400">
      Wybierz drużynę, aby edytować jej budżet.
    </div>
  </div>
</template>
