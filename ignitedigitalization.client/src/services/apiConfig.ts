...
const endpoints = {
  ...
  admin: {
    ...
    deck: {
      ...
      getFeedbacks: (cardId: number, deckId: number) => `/admin/deck/feedbacks?cardId=${cardId}&deckId=${deckId}`,
      updateFeedbacks: (cardId: number, deckId: number) => `/admin/deck/feedbacks/edit?cardId=${cardId}&deckId=${deckId}`,
